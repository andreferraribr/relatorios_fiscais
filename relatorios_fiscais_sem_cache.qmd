...
criterios_rreo_A06_juros_ativos_passivos_A06 <- list(
  ...
  `43  Fundos - Juros (Filtro Específico)` = list(
    criterio = "
    orgao_uge_tipo_administracao_codigo == '7' & 
...
# Resultado Nominal (ajustar se tiver variavel especifica)
valor_res_nominal <- tryCatch({
  if (exists("valor_resultado_nominal")) valor_resultado_nominal else NA_real_
}, error = function(e) NA_real_)
...
sistema_rreo <- tibble(
  ...
  valor = c(
    valor_bo_prev_ini, valor_bo_prev_atu, valor_bo_rec_rea, NA_real_,
