...
criterios_rreo_A06_despesas_natureza_detalhada_A06 <- list(
  ...
  (natureza_despesa_detalhada_codigo %in% c('45909206', '45909208', '45909266') |
   str_detect(natureza_despesa_detalhada_codigo, '^45..6600$')) & 
  !acao_governo_codigo %in% c('0021', '0029', '0030', '0031', '0061', '006A', '0427', 
                             '0534', '0A81', '0A84', '2130', '0062', '00DD', '00S5', 
                             '20GI', '006C', '00ED', '00EE', '00SG')
  "
...
# ==============================================================================
# Calcula o resultado primário a partir do dataframe rreo_a06_final

# ------------------------------------------------------------------------------
# Função auxiliar: busca valor pela categoria
# ------------------------------------------------------------------------------
obter_valor <- function(codigo) {
  # Busca linha que começa com o código (ex: "01  ", "12  ")
...
# ------------------------------------------------------------------------------
# Fórmula: Rec. Correntes (I) + Rec. Capital (V) - itens não-primários
# Itens não-primários: Aplic. Financeiras (II), Outras Rec. Financeiras (III),
#                      Op. Crédito (VI), Amort. Empréstimos (VII),
#                      Alien. Invest. Perm. (IX), Outras Rec. Cap. NP (X)

receita_primaria_total <- obter_valor(1) + obter_valor(12) -  # Correntes + Capital
                          obter_valor(5) - obter_valor(9) -   # - II - III
                          obter_valor(13) - obter_valor(14) - # - VI - VII
                          obter_valor(16) - obter_valor(20)   # - IX - X

# ------------------------------------------------------------------------------
# DESPESA PRIMÁRIA TOTAL
# ------------------------------------------------------------------------------
# Fórmula: Desp. Correntes (XIII) + Desp. Capital (XVI) - itens não-primários
# Itens não-primários: Juros e Encargos (XIV), Concessão Empréstimos (XVII),
#                      Amortização Dívida (XX)

despesa_primaria_total <- obter_valor(23) + obter_valor(28) - # Correntes + Capital
                          obter_valor(25) -                    # - XIV
                          obter_valor(34) - obter_valor(31)    # - XVII - XX

# ------------------------------------------------------------------------------
# RESULTADO PRIMÁRIO
# ------------------------------------------------------------------------------
resultado_primario <- receita_primaria_total - despesa_primaria_total

# Exibir resultado
cat("RESULTADO PRIMÁRIO\n")
cat("─────────────────────────────────────────\n")
cat("Receita Primária Total: ", formatar_numero(receita_primaria_total), "\n")
cat("Despesa Primária Total: ", formatar_numero(despesa_primaria_total), "\n")
cat("─────────────────────────────────────────\n")
