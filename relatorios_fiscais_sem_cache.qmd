...
# Calcular DCL numérico
valor_dcl_num <- (valores_linhas %>% 
  filter(ordem %in% c("01", "02", "03", "04", "05", "26", "06","07", "08", "09", "10", "38")) %>% 
  summarise(valor = sum(valor)))$valor - 
  (valores_linhas %>% 
  filter(ordem %in% c("11","12", "14", "15", "16", "20", "21", "22", "23", "25")) %>% 
  summarise(valor = sum(valor)))$valor
...
# ==============================================================================
# Fórmula: RN = DCL(dez/24) - DCL(nov/25)
# ==============================================================================
...
# ==============================================================================
# RREO ANEXO 6 - RESULTADO NOMINAL ABAIXO DA LINHA E DISCREPÂNCIA
# ==============================================================================
# Fórmula: 
#   RN Abaixo da Linha = DCL(dez/24) - DCL(atual)
#   Discrepância = RN Acima da Linha - RN Abaixo da Linha
#
# Pré-requisitos:
#   - valor_dcl_num (calculado no chunk da DCL, valor numérico)
#   - resultado_nominal_final (calculado no chunk Resultado Primário e Nominal)
# ==============================================================================
...
# Resultado Nominal Acima da Linha (já calculado anteriormente)
