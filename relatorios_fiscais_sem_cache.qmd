...
# Cada item replica EXATAMENTE uma linha do grupo "Ajustes Resultado Primário/Nominal - 2025"
# Critérios incluem TODOS os atributos visíveis nos prints (conta, UG executora, evento, etc.)
# ===============================================================================
criterios_rreo_A06_ajuste <- list(
  ...
  `50 VPD - Variações Monetárias da Dívida Contratual` = list(
    criterio = "
    conta_contabil_numero %in% c('34310100', '343540100', '343550100')
    "
  ),
  ...
  `54 VPD - Atualização Monetária Negativa` = list(
    criterio = "
    conta_contabil_numero %in% c('343910103', '343950103') &
  ...
  `57 VPD - Constituição de Subvenções Econômicas - COPEC` = list(
    ...
    (conta_contabil_numero %in% c('217710101', '227710101', '222210200', '212210300',
                                  '222110200', '212110301', '212110303', '212110700',
                                  '212210601', '212310201', '212310202', '212410201',
                                  '217310301', '217310602', '217350402', '222310102',
                                  '222410101', '227310301') &
     evento_codigo == '581012' &
  ...
  `59 VPD - Desincorporação de Ativos` = list(
    criterio = "
    conta_contabil_numero %in% c('365010100', '365040100', '365110100', '365140100') &
  ...
  `61 VPD - Var Monet e Cambiais de Emprest e Financ Concedidos` = list(
    ...
    ug_executora_codigo %in% c('170512', '170526', '170600', '170700', '380916', '170705')
    "
  ),
  ...
  `62 VPA - Var Monet e Cambiais de Emprest e Financ Concedidos` = list(
    criterio = "
    conta_contabil_numero %in% c('443110100', '443310100', '443410100', '443510100') &
    ug_executora_codigo %in% c('170512', '170526', '170600', '170700', '380916', '170705')
    "
  ),
  ...
  `65 VPA - Outras Variações Cambiais` = list(
    ...
    ug_executora_codigo %in% c('170512', '170526', '170600', '170700', '120002',  '170705')
    "
  ),
  ...
  `66 VPA - Ganhos com Desincorporação de Passivos` = list(
    criterio = "
    conta_contabil_numero %in% c('464010100', '464040100', '464110100',
                                '464140100', '464150100') &
    ug_executora_codigo == '170600'
    "
  ),
  ...
  `68 VPA - Outras Variações Patrimoniais Aumentativas` = list(
    criterio = "
    conta_contabil_numero %in% c('449010100', '449040100', '449100100',
                                '449140100', '449150100') &
  ...
  `70 VPA - Reversão de Provisões e de Ajustes para Perdas` = list(
    ...
    conta_contabil_numero %in% c('497110100', '497140100', '497150100',
                                '497210100', '497240100') &
    ug_executora_codigo %in% c('170700', '170705', '170512', '170526')
    "
  ),
  ...
  `74 Juros e Encargos Passivos - Outras VPD Financeiras` = list(
    ...
    ug_executora_codigo %in% c('170512', '170500')
    "
  ),
