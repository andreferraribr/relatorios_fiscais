...
criterios_rreo_A06_juros_ativos_passivos_A06 <- list(
  ...
  # JUROS ATIVOS (XXV) - VPA Classe 4 - O que a União RECEBE
  # Contas começando com 44
  `41  Juros Ativos` = list(
    criterio = "
    substr(conta_contabil_numero, 1, 2) == '44'
    "
  ),
  
  # JUROS PASSIVOS (XXVI) - VPD Classe 3 - O que a União PAGA
  # Contas começando com 34
  `42  Juros Passivos` = list(
    criterio = "
    substr(conta_contabil_numero, 1, 2) == '34'
    "
  ),
  
  # FUNDOS - JUROS ATIVOS (contas 44)
  ...
  # FUNDOS - JUROS PASSIVOS (contas 34)
...
# 7. JUROS NOMINAIS 
# ------------------------------------------------------------------------------
# Fonte: tg_RPN_juros.xlsx (valores base) + balancete (variações)
#
...
# --- 7.1 JUROS BASE (do arquivo tg_RPN_juros.xlsx) ---
arquivo_juros <- str_c(mes_pasta, "tg_RPN_juros.xlsx")
