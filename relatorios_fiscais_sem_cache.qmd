...
# ===============================================================================
# PROCESSAR: rgf_a02_dcl_passivo_atuarial
# ===============================================================================
...
# ============================================================================
# TABELA DE REFERÊNCIA DOS TÍTULOS PÚBLICOS
# ============================================================================
...
titulos_publicos <- tribble(
  ...
  # === TÍTULOS ATIVOS ===
  "LTN",                "LTN",      "Letra do Tesouro Nacional",                       "Prefixada (taxa fixa)",       "Ativo (Tesouro Prefixado)",                 "Pagamento único no vencimento",
  "LTN-DL 2376",        "LTN",      "Letra do Tesouro Nacional",                       "Prefixada (taxa fixa)",       "Ativo (Tesouro Prefixado)",                 "Pagamento único no vencimento",
  ...
  "LFT",                "LFT",      "Letra Financeira do Tesouro",                     "Pós-fixada (Selic)",          "Ativo (Tesouro Selic)",                      "Reserva de emergência",
  "DP7000001",          "LFT",      "Letra Financeira do Tesouro",                     "Pós-fixada (Selic)",          "Ativo (Tesouro Selic) - Mercado",           "Mercado",
  "DP7000010",          "LFT",      "Letra Financeira do Tesouro",                     "Pós-fixada (Selic)",          "Ativo (Tesouro Selic) - BACEN",             "BACEN",
  
  "NTN-F",              "NTN-F",    "Nota do Tesouro Nacional Série F",                "Prefixada + cupons semestrais", "Ativo (Tesouro Prefixado c/ Juros)",      "Paga juros a cada 6 meses",
  "DP2300007",          "NTN-F",    "Nota do Tesouro Nacional Série F",                "Prefixada + cupons semestrais", "Ativo (Tesouro Prefixado c/ Juros) - Mercado", "Mercado",
  "DP2300010",          "NTN-F",    "Nota do Tesouro Nacional Série F",                "Prefixada + cupons semestrais", "Ativo (Tesouro Prefixado c/ Juros) - BACEN", "BACEN",
  
  "NTN-B",              "NTN-B",    "Nota do Tesouro Nacional Série B",                "IPCA + taxa fixa",            "Ativo (Tesouro IPCA+ c/ Juros)",             "Protege da inflação",
  "DP1700001",          "NTN-B",    "Nota do Tesouro Nacional Série B",                "IPCA + taxa fixa",            "Ativo (Tesouro IPCA+ c/ Juros) - Mercado",  "Mercado",
  "DP1700010",          "NTN-B",    "Nota do Tesouro Nacional Série B",                "IPCA + taxa fixa",            "Ativo (Tesouro IPCA+ c/ Juros) - BACEN",    "BACEN",
  
  "NTN-B1",             "NTN-B1",   "Nota do Tesouro Nacional Série B1",               "IPCA + taxa fixa",            "Ativo (Tesouro Renda+ e Educa+)",           "Aposentadoria/educação",
  "DP9102001",          "NTN-B1",   "Nota do Tesouro Nacional Série B1",               "IPCA + taxa fixa",            "Ativo (Tesouro Renda+ e Educa+)",           "Focado em longo prazo",
  
  # === TÍTULOS EXTINTOS OU RAROS ===
  "NTN-C",              "NTN-C",    "Nota do Tesouro Nacional Série C",                "IGP-M + taxa fixa",           "Extinto (ainda circula pouco)",              "Indexado ao IGP-M",
  "DP1400001",          "NTN-C",    "Nota do Tesouro Nacional Série C",                "IGP-M + taxa fixa",           "Extinto (ainda circula pouco)",              "Inflação antiga",
  
  "NTN-I",              "NTN-I",    "Nota do Tesouro Nacional Série I",                "Prefixada ou específica",     "Raro/extinto",                               "Pouco usado hoje",
  "DP2600001",          "NTN-I",    "Nota do Tesouro Nacional Série I",                "Prefixada ou específica",     "Raro/extinto",                               "Emissões antigas",
  
  "NTN-P",              "NTN-P",    "Nota do Tesouro Nacional Série P",                "Prefixada ou híbrida",        "Extinto ou raro",                            "Série antiga",
  "DP1800001",          "NTN-P",    "Nota do Tesouro Nacional Série P",                "Prefixada ou híbrida",        "Extinto ou raro",                            "Emissões antigas",
  "DP1800010",          "NTN-P",    "Nota do Tesouro Nacional Série P",                "Prefixada ou híbrida",        "Extinto ou raro - BACEN",                    "BACEN",
  
  # === CFT - CERTIFICADOS FINANCEIROS DO TESOURO ===
  "CFT-A",              "CFT-A",    "Certificado Financeiro do Tesouro Série A",       "Variável (Selic ou TR)",      "Emissões diretas",                           "Programas específicos",
  "DP1000001",          "CFT-A",    "Certificado Financeiro do Tesouro Série A",       "Variável (Selic ou TR)",      "Emissões diretas",                           "Não leilão comum",
  
  "CFT-B",              "CFT-B",    "Certificado Financeiro do Tesouro Série B",       "Variável (Selic ou TR)",      "Emissões diretas",                           "FIES, Proies",
  "DP1200001",          "CFT-B",    "Certificado Financeiro do Tesouro Série B",       "Variável (Selic ou TR)",      "Emissões diretas",                           "Programas governamentais",
  
  "CFT-D",              "CFT-D",    "Certificado Financeiro do Tesouro Série D",       "Variável (Selic ou TR)",      "Emissões diretas",                           "Programas específicos",
  "DP2000001",          "CFT-D",    "Certificado Financeiro do Tesouro Série D",       "Variável (Selic ou TR)",      "Emissões diretas",                           "Não leilão",
  
  "CFT-E",              "CFT-E",    "Certificado Financeiro do Tesouro Série E",       "Variável (Selic ou TR)",      "Emissões diretas",                           "Programas específicos",
  "DP2800001",          "CFT-E",    "Certificado Financeiro do Tesouro Série E",       "Variável (Selic ou TR)",      "Emissões diretas",                           "FIES",
  
  # === CVS - CERTIFICADOS DE VALORIZAÇÃO DO SALÁRIO (ANOS 90) ===
  "CVSA970101",         "CVS-A",    "Certificado de Valorização do Salário Série A",   "Correção salarial (1997)",    "Extinto/prescrito",                          "Dívidas salariais anos 90",
  "DP3201250",          "CVS-A",    "Certificado de Valorização do Salário Série A",   "Correção salarial (1997)",    "Extinto/prescrito",                          "Salários atrasados",
  
  "CVSB970101",         "CVS-B",    "Certificado de Valorização do Salário Série B",   "Correção salarial (1997)",    "Extinto/prescrito",                          "Dívidas salariais anos 90",
  "DP3201275",          "CVS-B",    "Certificado de Valorização do Salário Série B",   "Correção salarial (1997)",    "Extinto/prescrito",                          "Salários atrasados",
  
  "CVSC970101",         "CVS-C",    "Certificado de Valorização do Salário Série C",   "Correção salarial (1997)",    "Extinto/prescrito",                          "Dívidas salariais anos 90",
  "DP3201276",          "CVS-C",    "Certificado de Valorização do Salário Série C",   "Correção salarial (1997)",    "Extinto/prescrito",                          "Salários atrasados",
  
  "CVSD970101",         "CVS-D",    "Certificado de Valorização do Salário Série D",   "Correção salarial (1997)",    "Extinto/prescrito",                          "Dívidas salariais anos 90",
  "DP3201277",          "CVS-D",    "Certificado de Valorização do Salário Série D",   "Correção salarial (1997)",    "Extinto/prescrito",                          "Salários atrasados",
  
  # === TÍTULOS DE SECURITIZAÇÃO (ANOS 90) ===
  "BNCC920116",         "BNCC",     "Título de Securitização - Bônus do Crédito",      "Variável",                    "Extinto",                                    "Dívidas judiciais anos 90",
  "DP3201031",          "BNCC",     "Título de Securitização - Bônus do Crédito",      "Variável",                    "Extinto",                                    "Precatórios",
  
  "JUST920116",         "JUST",     "Título de Securitização - Justiça",               "Variável",                    "Extinto",                                    "Dívidas judiciais anos 90",
  "DP3201032",          "JUST",     "Título de Securitização - Justiça",               "Variável",                    "Extinto",                                    "Precatórios",
  
  "SUMA920199",         "SUMA",     "Título Antigo de Securitização",                  "Variável",                    "Extinto",                                    "Anos 90",
  "DP3201145",          "SUMA",     "Título Antigo de Securitização",                  "Variável",                    "Extinto",                                    "Emissões antigas",
  
  "CDP/INSS",           "CDP",      "Certificado da Dívida Previdenciária",            "Variável",                    "Extinto",                                    "Quitar dívidas com INSS",
  "DP3000001",          "CDP",      "Certificado da Dívida Previdenciária",            "Variável",                    "Extinto",                                    "Dívida INSS",
  
  # === DÍVIDA EXTERNA ===
  "GLOBAL",             "GLOBAL",   "Global Bonds (dívida externa em USD)",            "Prefixada USD + câmbio",      "Ativo - circulação",                         "Emitidos no exterior (USD)",
  "DP1300003",          "GLOBAL",   "Global Bonds (dívida externa em USD)",            "Prefixada USD + câmbio",      "Ativo - circulação",                         "Correção cambial",
  
  "GLOBAL BRL",         "GLOBAL-BRL", "BRL Bonds (dívida externa em R$)",              "Prefixada em real",           "Ativo - circulação",                         "Emitidos fora em reais (2005+)",
  "DP1300004",          "GLOBAL-BRL", "BRL Bonds (dívida externa em R$)",              "Prefixada em real",           "Ativo - circulação",                         "Mercado internacional",
  
  # === TÍTULOS DA DÍVIDA AGRÁRIA ===
  "TDA",                "TDA",      "Títulos da Dívida Agrária",                       "Variável",                    "Ativo",                                      "Reforma agrária",
  "212110202",          "TDA",      "Títulos da Dívida Agrária",                       "Variável",                    "Ativo - Curto Prazo",                        "Passivo Circulante",
  "222110102",          "TDA",      "Títulos da Dívida Agrária",                       "Variável",                    "Ativo - Longo Prazo",                        "Passivo Não-Circulante"
)
...
categorias_titulos <- tribble(
  ...
  "LFT",        "Pós-fixados",                 "Selic",
  "NTN-F",      "Prefixados",                  "Com Cupons",
  "NTN-B",      "Indexados à Inflação",        "IPCA",
  "NTN-B1",     "Indexados à Inflação",        "IPCA - Longo Prazo",
  "NTN-C",      "Indexados à Inflação",        "IGP-M (Extinto)",
  ...
  "CVS-A",      "Extintos",                    "Correção Salarial",
  "CVS-B",      "Extintos",                    "Correção Salarial",
  "CVS-C",      "Extintos",                    "Correção Salarial",
  "CVS-D",      "Extintos",                    "Correção Salarial",
  "BNCC",       "Extintos",                    "Securitização",
  "JUST",       "Extintos",                    "Securitização",
  "SUMA",       "Extintos",                    "Securitização",
  "CDP",        "Extintos",                    "Dívida Previdenciária",
  "GLOBAL",     "Dívida Externa",              "USD",
  "GLOBAL-BRL", "Dívida Externa",              "BRL",
  "TDA",        "Dívida Agrária",              "Reforma Agrária"
)

# ============================================================================
# FUNÇÃO: ENRIQUECER DADOS DO TG COM INFORMAÇÕES DOS TÍTULOS
# ============================================================================

#' Enriquecer dados do Tesouro Gerencial com informações dos títulos
#' @param df Dataframe com dados do TG (deve ter coluna entidade_c_cor_numero ou similar)
#' @param coluna_codigo Nome da coluna com código do título (padrão: "entidade_c_cor_numero")
#' @return Dataframe enriquecido com informações dos títulos
enriquecer_titulos <- function(df, coluna_codigo = "entidade_c_cor_numero") {
  
  # Verificar se coluna existe
  if (!coluna_codigo %in% names(df)) {
    stop(sprintf("Coluna '%s' não encontrada no dataframe", coluna_codigo))
  }
  
  # Fazer join com tabela de títulos
  df_enriquecido <- df %>%
    left_join(
      titulos_publicos,
...
#' Buscar informações de um título específico
#' @param codigo Código do título
#' @return Tibble com informações do título
buscar_titulo <- function(codigo) {
  titulos_publicos %>%
    filter(codigo_tg == codigo)
}

#' Listar todos os títulos ativos
#' @return Tibble com títulos ativos
...
#' Listar títulos por categoria
#' @param categoria Nome da categoria
#' @return Tibble com títulos da categoria
...
cat("\n")
cat("═══════════════════════════════════════════════════════════════\n")
cat("         📊 MAPEAMENTO DE TÍTULOS PÚBLICOS CARREGADO\n")
cat("═══════════════════════════════════════════════════════════════\n")
cat(sprintf("✅ Total de títulos mapeados: %d\n", nrow(titulos_publicos)))
cat(sprintf("✅ Categorias: %d\n", nrow(categorias_titulos)))
cat("\n📝 Funções disponíveis:\n")
cat("   • enriquecer_titulos(df, coluna_codigo)\n")
cat("   • buscar_titulo(codigo)\n")
cat("   • listar_titulos_ativos()\n")
cat("   • listar_por_categoria(categoria)\n")
cat("\n💡 Dataframes disponíveis:\n")
cat("   • titulos_publicos\n")
cat("   • categorias_titulos\n")
cat("═══════════════════════════════════════════════════════════════\n\n")
...
# Enriquecer com informações dos títulos
...
# ============================================================================
# ADICIONAR DETENTOR E PRAZO AOS DADOS - VERSÃO DIRETA E SIMPLES
# ============================================================================
# Código simplificado para equipe com pouco conhecimento de R
# Autor: André
# Data: 2024
# ============================================================================
...
# ============================================================================
# MANIPULAÇÃO DIRETA: ADICIONAR COLUNAS DETENTOR E PRAZO
# ============================================================================
...
dados_enriquecidos <- rgf_a02_entidade %>%
  mutate(
    ...
    # COLUNA 2: PRAZO
    # Busca palavras-chave no nome da conta contábil
    prazo = case_when(
      str_detect(conta_contabil_nome, regex("Curto Prazo|Circulante", ignore_case = TRUE)) ~ "Curto Prazo",
      str_detect(conta_contabil_nome, regex("Longo Prazo|Não.?Circulante", ignore_case = TRUE)) ~ "Longo Prazo",
...
# Aplicar critérios e SALVAR (importante para consolidação)
garantias_processado <- aplicar_criterios(
  rgf_a03, 
  criterios_rgf_A03_garantias
)

# Agregar para exibição
...
```{r}
# Tabela estruturada para RPPS (Regime Próprio de Previdência Social)
...
criterios_rreo_A06_juros_ativos_passivos_A06 <- list(
  ...
  # Contas específicas: 445110100, 445210100
...
# VERSÃO CORRIGIDA - baseada nos prints oficiais do TG
#
# OBSERVAÇÃO IMPORTANTE:
# Os atributos "NS - Classificação Contábil 1" e "NS - Classificação Contábil 2"
# foram OMITIDOS pois inviabilizavam a geração do relatório por exceder o limite
# de spool do TG. Isso pode causar diferenças em alguns itens (especialmente 57).
#
# VALIDAÇÃO: 19/23 itens OK (83%)
# 
# ITENS COM PROBLEMAS (necessitam reextração do TG):
# - Item 50: Conta 343110100 NÃO EXISTE no arquivo rreo_a06_ajustes.xlsx
# - Item 57: Atributos NS Classif. Contábil 1 e 2 foram omitidos
# - Item 59: Contas 365010100, 365040100, 365050100, 365150100 não existem no arquivo
# - Item 62: Contas 443140100, 443150100, 443340100 não existem no arquivo
# ===============================================================================
...
criterios_rreo_A06_ajuste <- list(
  ...
  # 
  # NOTA: A conta 343110100 NÃO EXISTE no arquivo rreo_a06_ajustes.xlsx
  # Isso causa diferença de ~906 mi. Necessário reextrair do TG.
  # ---------------------------------------------------------------------------
  ...
  # ---------------------------------------------------------------------------
  # CONSTITUIÇÃO DE SUBVENÇÕES ECONÔMICAS - COPEC
  # Print: vpd_09.png
  # UG: 170700
  # Contas: 395010100, 395110100
  # Evento: 581012
  # 
  # NOTA IMPORTANTE: O critério oficial também usa:
  # - NS Classificação Contábil 1: 217710101, 227710101, 222210200, 212210300,
  ...
  # - NS Classificação Contábil 2: 395010100, 395110100
  # Estes atributos foram OMITIDOS do arquivo, causando diferença de ~9.7 bi
  ...
  # (UG: 170512, 170700) OU (UG 380916 E NS Classif. Contábil 2: 121110309)
  # NOTA: O filtro de NS Classif. Contábil 2 foi omitido
  # ---------------------------------------------------------------------------
  ...
  # UGs: 170512, 170700
  #
  # NOTA: No arquivo atual só existem 365110100 e 365140100
  # As contas 365010100, 365040100, 365050100, 365150100 NÃO EXISTEM
  # Isso causa diferença de ~84 mi. Necessário reextrair do TG.
  # ---------------------------------------------------------------------------
  ...
  # UGs: 170512, 170526, 170705, 170600, 380916, 170700
  #
  # NOTA: No arquivo atual só existem 443110100 e 443310100
  # As contas 443140100, 443150100, 443340100 NÃO EXISTEM
  # Isso causa diferença de ~55 bi. Necessário reextrair do TG.
  # ---------------------------------------------------------------------------
  ...
  # ---------------------------------------------------------------------------
  # VPA - REMUNERAÇÃO DOS DEPÓSITOS BANCÁRIOS (FINANCEIRO???)
  # Print: vpd_07.png
  # Contas: 445110100, 445210100
  # AND NOT (Órgão UGE Tipo Administração = 7:FUNDOS) EXCETO UG 380916
  # Evento Não em: 581798, 586798
  # ---------------------------------------------------------------------------
  ...
  # Print: vpd_08.png
  # Conta: 622130200
  # UG Executora NÃO RELACIONADO: 170600 (ou seja, EXCLUI a UG 170600!)
  # ---------------------------------------------------------------------------
...
![ajustar totalização](subsitio_cesef.png)
...
# ==============================================================================
# Dados: rreo_a06_final (TG)
# Ajuste Metodológico: comparativo.xlsx (outra área - RTN)
#
# Fórmulas:
#   Receita Primária = Rec. Correntes - Aplicações Fin. - Outras Rec. Fin. + Rec. Capital Primárias
#   Despesa Primária = Desp. Correntes - Juros Dívida + Desp. Capital - Amortização - Conc. Empréstimos + Subsídios
#   RP TG = Receita Primária - Despesa Primária
#   Ajuste Metodológico = SOMA(RP_RTN_mensal) × 1.000.000 - RP TG
#   RP Final = RP TG + Ajuste
...
# ------------------------------------------------------------------------------
# 2. RECEITAS PRIMÁRIAS (dados do TG)
# ------------------------------------------------------------------------------
# 01 RECEITAS CORRENTES (I)
# 05 Aplicações Financeiras (II) - deduzir
# 09 Outras Receitas Financeiras (III) - deduzir
# 12 RECEITAS DE CAPITAL (V)
# 13 Operações de Crédito (VI) - deduzir
# 14 Amortização de Empréstimos (VII) - deduzir
# 20 Outras Receitas de Capital Não Primárias (X) - deduzir
...
# ------------------------------------------------------------------------------
# 3. DESPESAS PRIMÁRIAS (dados do TG)
# ------------------------------------------------------------------------------
# 23 DESPESAS CORRENTES (XIII)
# 25 Juros e Encargos da Dívida (XIV) - deduzir
# 28 DESPESAS DE CAPITAL (XVI)
# 31 Amortização da Dívida (XX) - deduzir
# 34 Concessão de Empréstimos e Financiamentos (XVII) - deduzir
# 37 Subsídios (metodologia CESEF - financeiro primário) - somar
...
despesa_primaria_capital <- desp_capital - amort_divida - conc_emprestimos
despesa_primaria_total <- despesa_primaria_corrente + despesa_primaria_capital + subsidios_cesef
...
cat("=== APURAÇÃO PELO TG ===\n")
cat(sprintf("Receita Primária Corrente:  R$ %s\n", format(receita_primaria_corrente, big.mark = ".", decimal.mark = ",")))
cat(sprintf("Receita Primária Capital:   R$ %s\n", format(receita_primaria_capital, big.mark = ".", decimal.mark = ",")))
cat(sprintf("Receita Primária Total:     R$ %s\n", format(receita_primaria_total, big.mark = ".", decimal.mark = ",")))
cat(sprintf("\nDespesa Primária Corrente:  R$ %s\n", format(despesa_primaria_corrente, big.mark = ".", decimal.mark = ",")))
cat(sprintf("Despesa Primária Capital:   R$ %s\n", format(despesa_primaria_capital, big.mark = ".", decimal.mark = ",")))
cat(sprintf("(+) Subsídios CESEF:        R$ %s\n", format(subsidios_cesef, big.mark = ".", decimal.mark = ",")))
cat(sprintf("Despesa Primária Total:     R$ %s\n", format(despesa_primaria_total, big.mark = ".", decimal.mark = ",")))
cat(sprintf("\n>>> Resultado Primário TG:  R$ %s\n", format(resultado_primario_tg, big.mark = ".", decimal.mark = ",")))

# ------------------------------------------------------------------------------
# 5. AJUSTE METODOLÓGICO - Dados do Comparativo CESEF (outra área)
# ------------------------------------------------------------------------------
...
ajuste_metodologico <- tryCatch({
  if (file.exists(arquivo_comparativo)) {
    ...
    # Determinar colunas baseado no mês de referência
    # 2025: CH=jan(1), CI=fev(2), ..., CR=nov(11), CS=dez(12)
    mes_ref <- as.numeric(substr(mes_filtro, 5, 6))
    
    # Colunas de 2025 começam em CH (coluna 86)
    col_inicio <- 86  # CH = janeiro/2025
    col_fim <- col_inicio + mes_ref - 1  # Até o mês de referência
    
    # Ler dados do RP RTN (linha 6) - valores em R$ milhões
    ...
    # Soma do RP RTN em milhões
    soma_rp_rtn_milhoes <- sum(as.numeric(rp_rtn_dados), na.rm = TRUE)
    
    # Converter para unidades (milhões × 1.000.000)
    soma_rp_rtn_unidades <- soma_rp_rtn_milhoes * 1000000
    
    # Ajuste Metodológico = RP RTN - RP TG
    ajuste <- soma_rp_rtn_unidades - resultado_primario_tg
    
    cat(sprintf("\n=== AJUSTE METODOLÓGICO (Comparativo CESEF - outra área) ===\n"))
    cat(sprintf("Arquivo: %s\n", arquivo_comparativo))
    cat(sprintf("Período: Jan/%s a %s/%s (%d meses)\n", 
                substr(mes_filtro, 1, 4),
                format(as.Date(paste0(mes_filtro, "01"), "%Y%m%d"), "%b"),
                substr(mes_filtro, 1, 4),
                mes_ref))
    cat(sprintf("Soma RP RTN (R$ milhões):   %s\n", format(round(soma_rp_rtn_milhoes, 2), big.mark = ".", decimal.mark = ",")))
    cat(sprintf("Soma RP RTN (R$ unidades):  %s\n", format(soma_rp_rtn_unidades, big.mark = ".", decimal.mark = ",")))
    cat(sprintf(">>> Ajuste Metodológico:    R$ %s\n", format(ajuste, big.mark = ".", decimal.mark = ",")))
...
# ------------------------------------------------------------------------------
# 6. RESULTADO PRIMÁRIO FINAL (com ajuste)
# ------------------------------------------------------------------------------
resultado_primario_final <- resultado_primario_tg + ajuste_metodologico

cat(sprintf("\n=== RESULTADO PRIMÁRIO FINAL ===\n"))
cat(sprintf("RP TG + Ajuste Metodológico\n"))
cat(sprintf("%s + %s = %s\n",
            format(resultado_primario_tg, big.mark = ".", decimal.mark = ","),
            format(ajuste_metodologico, big.mark = ".", decimal.mark = ","),
            format(resultado_primario_final, big.mark = ".", decimal.mark = ",")))
cat(sprintf(">>> RP Final (R$ milhares): %s\n", format(resultado_primario_final / 1000, big.mark = ".", decimal.mark = ",")))

# ------------------------------------------------------------------------------
# 7. JUROS NOMINAIS 
# ------------------------------------------------------------------------------
# Fonte: rreo_a06_juros.xlsx (valores base) + balancete (variações)
#
# Juros Ativos = Base TG + Variações de Empréstimos/Financ. Concedidos + Atual. Monet.
# Juros Passivos = Base TG + Var. Monetária Contratual + Var. Monetária Mobiliária + Var. Empréstimos
# ------------------------------------------------------------------------------

cat("\n=== JUROS NOMINAIS ===\n")

# --- 7.1 JUROS BASE (do arquivo rreo_a06_juros.xlsx) ---
arquivo_juros <- str_c(mes_pasta, "rreo_a06_juros.xlsx")

juros_base <- tryCatch({
  if (file.exists(arquivo_juros)) {
    # Ler arquivo pulando as 5 primeiras linhas de cabeçalho
    df_juros <- read_excel(arquivo_juros, skip = 5)
    
    # Encontrar linha de Juros Ativos (XXV)
    linha_ativos <- df_juros %>% 
      filter(str_detect(`Conta Contábil`, "JUROS E ENCARGOS ATIVOS")) %>%
      slice(1)
    
    # Encontrar linha de Juros Passivos (XXVI)
    linha_passivos <- df_juros %>% 
      filter(str_detect(`Conta Contábil`, "JUROS E ENCARGOS PASSIVOS")) %>%
      slice(1)
    
    # Pegar valor da última coluna (mês mais recente)
    col_mes <- names(df_juros)[ncol(df_juros)]
    
    list(
      ativos = as.numeric(linha_ativos[[col_mes]]),
      passivos = as.numeric(linha_passivos[[col_mes]])
    )
  } else {
    warning(sprintf("Arquivo não encontrado: %s", arquivo_juros))
    list(ativos = NA, passivos = NA)
  }
}, error = function(e) {
  warning(sprintf("Erro ao ler juros: %s", e$message))
  list(ativos = NA, passivos = NA)
})

juros_ativos_base <- juros_base$ativos
juros_passivos_base <- juros_base$passivos

cat(sprintf("Arquivo: %s\n", arquivo_juros))
cat(sprintf("Juros Ativos BASE (XXV):    R$ %s\n", format(juros_ativos_base, big.mark = ".", decimal.mark = ",")))
cat(sprintf("Juros Passivos BASE (XXVI): R$ %s\n", format(juros_passivos_base, big.mark = ".", decimal.mark = ",")))

# --- 7.2 VARIAÇÕES MONETÁRIAS E CAMBIAIS (do balancete) ---
cat("\n--- Variações para Juros Ativos ---\n")

# Var. Monet. e Camb. de Empréstimos/Financiamentos CONCEDIDOS (VPA - classe 4)
# Contas 44311, 44314, 44315, 44331, 44334, 44335
var_emprest_ativos <- rgf_a02_balancete %>%
  filter(substr(conta_contabil_numero, 1, 5) %in% c('44311', '44314', '44315', '44331', '44334', '44335')) %>%
  summarise(v = sum(saldo_r_conta_contabil, na.rm = TRUE)) %>%
  pull(v)

cat(sprintf("Var. Empréstimos/Financ. Concedidos: R$ %s\n", 
            format(var_emprest_ativos, big.mark = ".", decimal.mark = ",")))

# Atualização Monetária Positiva (parte específica: 583.425.478,03)
# Este valor é fixo conforme metodologia da aba ELABORAÇÃO
atual_monet_ativos <- 583425478.03

cat(sprintf("Atualização Monetária Positiva:      R$ %s\n", 
            format(atual_monet_ativos, big.mark = ".", decimal.mark = ",")))

cat("\n--- Variações para Juros Passivos ---\n")

# Var. Monetária Dívida Contratual (343110100)
var_monet_contratual <- rgf_a02_balancete %>%
  filter(conta_contabil_numero == "343110100") %>%
  summarise(v = sum(saldo_r_conta_contabil, na.rm = TRUE)) %>%
  pull(v)

cat(sprintf("Var. Monetária Dívida Contratual:    R$ %s\n", 
            format(var_monet_contratual, big.mark = ".", decimal.mark = ",")))

# Var. Monetária Dívida Mobiliária (343310100)
var_monet_mobiliaria <- rgf_a02_balancete %>%
  filter(conta_contabil_numero == "343310100") %>%
  summarise(v = sum(saldo_r_conta_contabil, na.rm = TRUE)) %>%
  pull(v)

cat(sprintf("Var. Monetária Dívida Mobiliária:    R$ %s\n", 
            format(var_monet_mobiliaria, big.mark = ".", decimal.mark = ",")))

# Var. Monet. e Cambiais de Empréstimos/Financiamentos OBTIDOS (44351)
var_emprest_passivos <- rgf_a02_balancete %>%
  filter(substr(conta_contabil_numero, 1, 5) == '44351') %>%
  summarise(v = sum(saldo_r_conta_contabil, na.rm = TRUE)) %>%
  pull(v)

cat(sprintf("Var. Empréstimos/Financ. Obtidos:    R$ %s\n", 
            format(var_emprest_passivos, big.mark = ".", decimal.mark = ",")))

# --- 7.3 TOTAIS DE JUROS ---
juros_ativos <- juros_ativos_base + var_emprest_ativos + atual_monet_ativos
juros_passivos <- juros_passivos_base + var_monet_contratual + var_monet_mobiliaria + var_emprest_passivos

cat(sprintf("\n>>> JUROS ATIVOS TOTAL:   R$ %s\n", format(juros_ativos, big.mark = ".", decimal.mark = ",")))
cat(sprintf(">>> JUROS PASSIVOS TOTAL: R$ %s\n", format(juros_passivos, big.mark = ".", decimal.mark = ",")))
...
cat(sprintf("\n=== RESULTADO NOMINAL FINAL ===\n"))
cat(sprintf("RN = RP Final + Juros Ativos - Juros Passivos\n"))
cat(sprintf("RN = %s + %s - %s\n",
            format(resultado_primario_final, big.mark = ".", decimal.mark = ","),
            format(juros_ativos, big.mark = ".", decimal.mark = ","),
            format(juros_passivos, big.mark = ".", decimal.mark = ",")))
cat(sprintf(">>> Resultado Nominal: R$ %s\n", format(resultado_nominal_final, big.mark = ".", decimal.mark = ",")))
cat(sprintf(">>> RN (R$ milhares):  %s\n", format(resultado_nominal_final / 1000, big.mark = ".", decimal.mark = ",")))

# ------------------------------------------------------------------------------
# 9. TABELA RESUMO - RESULTADO PRIMÁRIO
# ------------------------------------------------------------------------------
resultado_primario <- tibble(
  componente = c(
    ...
    "  Despesa Primária de Capital (XVI - XX - XVII)",
    "  (+) Subsídios CESEF",
    "  DESPESA PRIMÁRIA TOTAL (XXIII)",
    "",
    "RESULTADO PRIMÁRIO TG (XII - XXIII)",
    "(+) Ajuste Metodológico CESEF",
    "RESULTADO PRIMÁRIO FINAL"
  ),
  valor = c(
    NA,
...
datatable(
  ...
  caption = "RREO Anexo 6 - Resultado Primário",
  options = list(pageLength = 20, dom = 't',
    columnDefs = list(list(className = 'dt-right', targets = c(1, 2)))),
  rownames = FALSE
) %>%
  formatStyle('componente', fontWeight = styleEqual(
    c("  RECEITA PRIMÁRIA TOTAL (XII)", "  DESPESA PRIMÁRIA TOTAL (XXIII)", 
      "RESULTADO PRIMÁRIO TG (XII - XXIII)", "RESULTADO PRIMÁRIO FINAL"),
    rep("bold", 4)
  ))

# ------------------------------------------------------------------------------
# 10. TABELA RESUMO - RESULTADO NOMINAL
# ------------------------------------------------------------------------------
resultado_nominal <- tibble(
  componente = c(
    "RESULTADO PRIMÁRIO FINAL",
    "",
    "JUROS E ENCARGOS ATIVOS (XXV)",
    "  Base TG (tg_RPN_juros)",
    "  (+) Var. Empréstimos/Financ. Concedidos",
    "  (+) Atualização Monetária Positiva",
    "",
    "JUROS E ENCARGOS PASSIVOS (XXVI)",
    "  Base TG (tg_RPN_juros)",
    "  (+) Var. Monetária Dívida Contratual",
    "  (+) Var. Monetária Dívida Mobiliária",
    "  (+) Var. Empréstimos/Financ. Obtidos",
    "",
    "RESULTADO NOMINAL (RP + XXV - XXVI)"
  ),
  valor = c(
    resultado_primario_final,
    NA,
    ...
    juros_passivos,
    juros_passivos_base,
    var_monet_contratual,
    var_monet_mobiliaria,
    var_emprest_passivos,
    NA,
...
datatable(
  ...
  caption = "RREO Anexo 6 - Resultado Nominal",
  options = list(pageLength = 20, dom = 't',
    columnDefs = list(list(className = 'dt-right', targets = c(1, 2)))),
  rownames = FALSE
) %>%
  formatStyle('componente', fontWeight = styleEqual(
    c("RESULTADO PRIMÁRIO FINAL", "JUROS E ENCARGOS ATIVOS (XXV)", 
      "JUROS E ENCARGOS PASSIVOS (XXVI)", "RESULTADO NOMINAL (RP + XXV - XXVI)"),
    rep("bold", 4)
  ))

# ------------------------------------------------------------------------------
# 11. EXPORTAR VARIÁVEIS PARA USO EM OUTROS CHUNKS
# ------------------------------------------------------------------------------
...
cat("valor_resultado_primario\n")
cat("valor_resultado_nominal\n")
cat("valor_ajuste_metodologico\n")
cat("valor_juros_ativos\n")
cat("valor_juros_passivos\n")
```
