...
estrutura <- tibble::tribble(
  ...
  "1_educacao",                   "Educação",                          "008, 012, 130, 133, 134",
...
# ==============================================================================
# Apenas valores realizados (sem limites)
# ==============================================================================
...
mapeamento_rgf <- tribble(
  ...
  "disponibilidade_apos_rp",    "D52",   "Disp. Caixa APÓS Inscrição RP",     "A05"
)
...
# -----------------------------------------------------------------------------
# Montar dataframe do sistema (apenas valores realizados, sem limites)
# -----------------------------------------------------------------------------
sistema_rgf <- tibble(
  item = c(
    "rcl",
...
# Verificar se arquivo comparativo existe
arquivo_comparativo <- file.path(mes_pasta, "comparativo.xlsx")
...
if (file.exists(arquivo_comparativo)) {
  ...
  # Usar primeira aba disponível (ou especificar nome correto)
  aba_usar <- abas_disponiveis[1]  # "Comparativo"
  
  # Ler planilha
  oficial_rgf_raw <- read_excel(arquivo_comparativo, sheet = aba_usar, col_names = FALSE)
  
  
  # Função para ler célula
  ...
  cat("✅ Valores oficiais RGF lidos:", sum(!is.na(oficial_rgf$valor_oficial)), "de", nrow(oficial_rgf), "\n")
  
} else {
  
  # Criar dataframe vazio se arquivo não existe
  oficial_rgf <- mapeamento_rgf %>%
    mutate(valor_oficial = NA_real_)
  
  cat("⚠️ Arquivo comparativo.xlsx não encontrado\n")
}
```
